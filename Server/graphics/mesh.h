...
class Mesh {
  public:
    ...
    Mesh(const std::string& Filename,length_t, bool flipUVs, bool flipAlls = false, bool fudge = false, bool doublefudge = false);
    ...
    bool                   m_Good();
  private:
    static const aiScene*  LoadFile(Assimp::Importer&,const std::string&,bool,bool);
